...
\begin{figure} [H]
	\includegraphics[width=13cm]{iris.png}
	\centering
\end{figure}
...
\begin{figure} [H]
	\includegraphics[width=13cm]{banana.png}
	\centering
\end{figure}
...
\begin{figure} [H]
	\includegraphics[width=13cm]{magic.png}
	\centering
\end{figure}
...
No gráfico abaixo, utilizamos os atributos Age e Positive como coordenadas. Podmeos ver de forma clara que as envoltórias de cada classe se interceptam, o que implica que os dados não são separáveis linearmente.

\begin{figure} [H]
	\includegraphics[width=13cm]{haberman.png}
	\centering
\end{figure}
